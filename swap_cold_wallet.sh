...
wget https://github.com/MasterCoinOne/MasterCoinV2/releases/download/v1.0.2.0/mastercoin-1.0.2-linux-qt.tar.gz -O mastercoin-1.0.2-linux.tar.gz
sudo chmod 775 mastercoin-1.0.2-linux.tar.gz
#unzip MasterCoin-1.0.0-x86_64-pc-linux-gnu.zip
tar -xvzf mastercoin-1.0.2-linux.tar.gz
sudo chmod 755 *
sudo rm -f mastercoin-1.0.2-linux.tar.gz
sudo mv  * /usr/bin
